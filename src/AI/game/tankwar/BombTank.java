...
public class BombTank {
	...
	private static Image[] imgs = { // �洢��ըͼƬ ��С����ı�ըЧ��ͼ
			tk.getImage(BombTank.class.getClassLoader().getResource(
					"/game/tankwar/Images/1.gif")),
			tk.getImage(BombTank.class.getClassLoader().getResource(
					"/game/tankwar/Images//2.gif")),
			tk.getImage(BombTank.class.getClassLoader().getResource(
					"/game/tankwar/Images/3.gif")),
			tk.getImage(BombTank.class.getClassLoader().getResource(
					"/game/tankwar/Images/4.gif")),
			tk.getImage(BombTank.class.getClassLoader().getResource(
					"/game/tankwar/Images/5.gif")),
			tk.getImage(BombTank.class.getClassLoader().getResource(
					"/game/tankwar/Images/6.gif")),
			tk.getImage(BombTank.class.getClassLoader().getResource(
					"/game/tankwar/Images/7.gif")),
			tk.getImage(BombTank.class.getClassLoader().getResource(
					"/game/tankwar/Images/8.gif")),
			tk.getImage(BombTank.class.getClassLoader().getResource(
					"/game/tankwar/Images/9.gif")),
			tk.getImage(BombTank.class.getClassLoader().getResource(
					"/game/tankwar/Images/10.gif")), };
	int step = 0;
