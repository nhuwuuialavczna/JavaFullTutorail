package AI.game.chinachess.view;

import AI.game.chinachess.chess.Board;
import AI.game.chinachess.chess.Piece;
import AI.game.chinachess.chess.Rules;
import AI.game.chinachess.control.GameController;
...
public class GameView {
    ...
    public void init(final Board board) {
        ...
        try {
            frame.setIconImage(ImageIO.read(this.getClass().getResourceAsStream("/game/chinachess/res/img/icon.png")));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        JLabel bgBoard = null;
        try {
            bgBoard = new JLabel(new ImageIcon(ImageIO.read(this.getClass().getResourceAsStream("/game/chinachess/res/img/board.png"))));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            lblPlayer = new JLabel(new ImageIcon(ImageIO.read(this.getClass().getResourceAsStream("/game/chinachess/res/img/r.png"))));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        for (Map.Entry<String, Piece> stringPieceEntry : pieces.entrySet()) {
            ...
            JLabel lblPiece = null;
            try {
                lblPiece = new JLabel(new ImageIcon(ImageIO.read(this.getClass().getResourceAsStream("/game/chinachess/res/img/" + key.substring(0, 2) + ".png"))));
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    public void showPlayer(char player) {
        try {
            lblPlayer.setIcon(new ImageIcon( ImageIO.read(this.getClass().getResourceAsStream("/game/chinachess/res/img/" +player + ".png"))));
        } catch (IOException e) {
            e.printStackTrace();
        }
        frame.setVisible(true);
