...
public class AIGame implements Player {
	EvalBoard eBoard;
	...
	public int[] DScore ={ 0, 1, 9, 85,769 };// Mảng điểm chặn
	public int[] AScore ={ 0, 2, 28, 256, 2308 };// Mảng điểm tấn công
	public boolean cWin = false;
	Point goPoint;
	public AIGame(BoardState board) {
